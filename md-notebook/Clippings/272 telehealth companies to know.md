---
title: "272 telehealth companies to know"
source: "https://www.beckershospitalreview.com/healthcare-information-technology/272-telehealth-companies-to-know-2026/"
author:
  - "[[Anna Falvey]]"
published: 2026-07-17
created: 2026-07-18
description: "Explore 272 telehealth companies to know in 2026 offering advanced virtual care solutions across the U.S. for patients and providers."
tags:
  - "clippings"
---
...
Below are 272 telehealth companies to know. We accepted [nominations](https://beckershealthcare.swoogo.com/list-nominations) for this list. Contact Anna Falvey at [afalvey@beckershealthcare.com](mailto:afalvey@beckershealthcare.com) with questions, comments, or to recommend a company for this list.
...
**19 Labs (Redwood City, Calif.).** 19 Labs offer enhanced telehealth technologies for employers and rural communities. The company provides point of care solutions that include advanced remote diagnostic devices plus AI, communication using video calls, and patient education.

**20/20NOW (Holbrook, N.Y.).** 20/20NOW is the inventor and leader of Ocular Telehealth. The company provides comprehensive eye exams and eye health screenings via telehealth. It partnered with General Vision Services in 2018 to create a mobile eye center featuring ocular telehealth.

**98point6 (Seattle).** 98point6 develops and licenses advanced software for virtual care, emphasizing AI-driven clinical support and EHR integration. Their scalable platform supports both live and asynchronous patient visits, enhancing efficiency and clinical outcomes across more than 4,000 conditions. The company partners with health systems to expand access, improve patient engagement and optimize provider efficiency. The company also introduced an asynchronous care module and acquired assets from a partner, further solidifying their position in the virtual care market by offering flexible, future-proof solutions.
...
**Access TeleCare (Dallas).** Access TeleCare is a national leader in acute specialty telemedicine, having launched more than 2,600 telemedicine programs and partnered with one in five U.S. hospitals across all 50 states. The company delivers more than 1 million patient encounters annually across specialties including behavioral health, neurology, hospitalist medicine and cardiology, reaching a coverage area representing more than 65% of the U.S. population. In 2006, Access TeleCare became the first telemedicine organization to receive the Joint Commission’s Gold Seal of Approval, an accolade it has earned every year since. In 2025, the company posted a 60% top-line revenue increase.

**Advaa Health (New York City).** Advaa Health offers physicians integrated medical practice software and digital health tools, including remote patient monitoring, chronic care management, behavioral health integration and direct primary care software.
...
**All Care Therapies (Woodland Hills, Calif.).** All Care Therapies is transforming pediatric therapy services with a virtual care platform that combines advanced technology with personalized therapy. The company’s platform offers easy access to experienced therapists from home, eliminating the need for clinic visits and addressing challenges like busy schedules and geographical constraints. They provide a comprehensive range of virtual services, secure video conferencing and educational resources for parents.

**AmplifyMD (Los Gatos, Calif.).** AmplifyMD provides hospitals with a scalable, many-to-many virtual care coverage model powered by AI, real-time data and EHR-integrated workflows. Founded in 2019, the company now powers more than 350 acute care virtual programs across 15-plus specialty fields, including telehospitalist, telestroke and telepsychiatry, supporting more than 500,000 patients. Hospitals using the platform have reduced program operational overhead by up to 50% while AI-enabled tools allow remote physicians to work up to twice as efficiently. In 2025, AmplifyMD closed a $20 million Series B round backed by Houston-based Memorial Hermann Health System and was named to KLAS Research’s “Top 20 Emerging Solutions” list.

**Amwell (Boston).** Amwell is building a hybrid care ecosystem that integrates in-person, virtual and automated care, supported by a comprehensive digital platform. The company collaborates with providers, payers and innovators to enhance patient care, improve outcomes and reduce costs. Amwell’s platform includes digital mental health programs like SilverCloud and partnerships with organizations such as Cleveland Clinic and New Hyde Park, N.Y.-based Northwell Health. With over 24 million virtual care visits, Amwell’s technology-driven approach aims to transform healthcare delivery and improve access to quality care. Amwell was also selected by the U.S. Defense Health Agency and partnered with Amplar Health to expand hybrid care services.

**Appinventiv (Delhi-NCR, India).** Appinventiv is a healthcare technology company specializing in the design and development of secure, telehealth solutions for healthcare providers, startups, hospitals and enterprises. The company’s core telehealth capabilities include custom telemedicine platform development, video consultation solutions, remote patient monitoring solutions, EHR integration, AI-powered clinical workflow automation, ePrescription and patient engagement solutions, multiplatform telehealth applications for web and mobile, and more. The company has helped healthcare organizations build scalable virtual care to improve patient access, streamline clinical workflows and support regulatory compliance.
...
**Axs Health (Redlands, Calif.).** Axs Healthcare is a digital patient engagement and asynchronous telemedicine platform specializing in orthopedic and multispecialty surgical practices.
...
**Beam Healthcare (Madison, Wis.).** Beam Healthcare brings tele-specialists, tele-hospitalist, tele-rt, and tele-case-management services to community hospitals, clinics, and PACE programs.
...
**Birches Health (New York City).** Birches Health is the leading national clinical provider for gambling disorder and other behavioral addictions, operating the largest network of clinicians trained specifically in gambling disorder treatment. Founded in 2023, the company delivers virtual care through more than 400 licensed providers across all 50 states, moving clients from initial outreach to their first session in under 48 hours. Clinical outcomes show 85% of clients report improved gambling disorder symptoms after nine sessions, with early client retention exceeding industry benchmarks by 29%. Birches Health raised $20 million in combined Series A and seed funding and won the 2026 MedTech “Breakthrough Award” for best telehealth platform.
...
**Blue Sky Telehealth (Greenwood Village, Colo.).** Blue Sky Telehealth provides emergency and routine telehealth consultations to improve access to specialized care. It provides cost-effective services for hospitals seeking immediate access to board-certified physicians.

**Blueberry Pediatrics (Mountain View, Calif.).** Blueberry Pediatrics gives families 24/7 access to board-certified pediatricians for hundreds of common childhood illnesses, paired with an at-home medical kit that includes an otoscope, pulse oximeter and thermometer. The company serves more than 100,000 members through direct-to-consumer subscriptions and payer and employer partnerships, reducing emergency department utilization by 20% to 40% while keeping 99% of visits out of the emergency room. Parent-reported NPS scores consistently exceed 90.
...
**Boulder Care (Portland, Ore.).** Boulder Care is a telehealth addiction treatment company delivering evidence-based care for substance use disorders entirely via smartphone, with no waiting rooms or transportation barriers. Founded in 2017, the company has treated 40,000 patients across seven states and conducts more than 210,000 telehealth visits annually, with an average of eight minutes from intake to seeing a provider. For 75% of patients, care is covered by Medicaid at no out-of-pocket cost. Boulder’s retention model keeps 71% of patients in care at six months, more than double the industry average of 22% to 30%.
...
**Brightline Health (San Mateo, Calif.).** Brightline is an award-winning therapy and psychiatry practice delivering pediatric, teen and parental mental health care through a hybrid in-person and virtual model. The company also operates BrightLife Kids, a free, statewide behavioral health platform serving families with children ages 0 to 12 across all 58 of California’s counties, which grew 165% in the past year. Brightline is backed by investors including Boston Children’s Hospital, New Hyde Park, N.Y.-based Northwell Health and Google Ventures, and recently announced a strategic partnership with Northwell to expand access across the region. The company was named the best overall mental health solution provider in the 2025 MedTech “Breakthrough Awards” and to the *Forbes “* America’s Best Startup Employers” list for a third consecutive year.
...
**Canon USA (Melville, N.Y.).** Canon USA’s remote eye screening technology is an intuitive software solution providers use to perform retinal screenings and then quickly transmit the images to physicians in any location for diagnostic purposes.
...
**CareSimple (North Palm Beach, Fla.).** CareSimple provides an EHR-integrated, end-to-end remote patient monitoring platform that combines cellular medical devices, patient engagement tools, and configurable clinical workflows to improve outcomes and reduce costs. Built for scalability, compliance and ease of use, the solution enables health systems, payers and physician groups to deliver personalized care at home. The company has been designated “Toolbox” by Epic, reflecting deep integration and streamlined deployment within health system environments. U.S. providers have onboarded 25,000-plus patients to CareSimple and shipped over 35,000 cellular devices, accelerating time-to-value and closing monitoring gaps across chronic populations.
...
**Central Valley Hospice Palliative Medicine (Fresno, Calif.).** Central Valley Hospice Palliative Medicine is a physician-led hospice and palliative care organization delivering technology-enabled serious-illness care to rural, low-income and culturally diverse communities across California’s Central Valley. It is the only Accreditation Commission for Health Care-accredited hospice agency in the country to receive a certificate of distinction in telehealth Hospice, reflecting its integration of telehealth into symptom management, medication optimization, advance care planning and caregiver coaching. The organization is also the first hospice provider in California’s Central Valley to earn the American Heart Association’s palliative/hospice heart failure certification. Its telehospice and telepalliative model aims to reduce avoidable emergency department visits and hospitalizations while improving care for patients with advanced cancer, heart failure and complex chronic illness.
...
**Charlie Health (Bozeman, Mont.).** Founded in 2020, Charlie Health is a behavioral healthcare provider for youth and adults in crisis. The company’s clinicians are committed to providing unparalleled access to evidence-based treatment. Through a virtual-first approach, the company delivers intensive behavioral health treatment designed specifically for a high acuity patient population.

**CharmHealth (Pleasanton, Calif.).** CharmHealth’s platform includes EHR, practice management, revenue cycle management, telehealth and mobile health applications. The company’s telehealth platform supports virtual patient visits.

**Children’s Health Virtual Care (Dallas).** Children’s Health is the leading pediatric health system in North Texas, having served the region for more than 113 years and caring for more than 370,000 patients annually across Children’s Medical Center Dallas, Children’s Medical Center Plano and more than 60 specialty centers. In 2013, the system launched TeleNICU, the state’s first dedicated pediatric telemedicine service, followed by a school-based telehealth program that now serves more than 260 schools across 30 North Texas districts with a 92% nurse satisfaction rate. In 2025 alone, the program facilitated more than 2,100 visits with a 97% parent satisfaction rate, while the system’s nurse advice line fielded more than 100,000 calls.
...
**Collette Health (Noblesville, Ind.).** Collette Health is a virtual care platform combining virtual observation, virtual nursing and workforce augmentation for more than 185 hospitals nationwide. The company has ranked No. 1 in the Best in KLAS virtual sitting and nursing category in both years the category has existed, earning a 91.5-out-of-100 performance score in 2026 based entirely on customer interviews. In October 2025, Collette Health acquired the Virtual Nursing Academy, making it the only virtual care provider to offer technology and clinical implementation education under one platform. In May 2026, the company announced a partnership with Ontario, Calif.-based Prime Healthcare, the fifth-largest for-profit health system in the U.S., to expand its virtual care rollout across the network.

**Conduit Health Partners (Cincinnati).** Conduit Health Partners is a nurse-led company providing nurse-first tele-triage and centralized patient transfer services to health systems nationwide. Since its founding, Conduit has managed more than 1 million triage encounters and now supports nearly 500 healthcare facilities across all 50 states through a workforce of more than 160 registered nurses. In 2025, the company doubled its nurse triage client base and supported 89 client expansions among existing health system partners. Conduit received a “Platinum eHealthcare Leadership Award” in 2023 for its search engine marketing nurse triage digital campaign.
...
**Counsel Health (Boston).** Counsel Health is an AI-enabled, physician-supervised primary care company that pairs medical AI with in-house physicians through a secure messaging interface, connecting members with a doctor in under two minutes when needed. The model has reduced emergency department visits by 24% compared with other consumer AI tools and resolved 96% of medical concerns without escalation to in-person care. In May 2026, the company announced a partnership with Oura to integrate its AI-enabled primary care platform into the Oura app. The company closed a $25 million Series A round in October 2025.
...
**Current Health (Boston).** Current Health provides the leading FDA-cleared, AI-powered remote patient monitoring platform to help healthcare providers reduce risk, cost, and readmissions while improving patient outcomes and delivering better, more proactive healthcare.
...
**Firefly Global (Belmont, Mass.).** Firefly Global is a provider of wireless portable microscopes and magnifying cameras with real-time video transmission. The products are designed for healthcare professionals, integrating with third-party video conferencing platforms to enable remote exams.

**First Stop Health (Chicago).** First Stop Health provides 24/7 virtual urgent, primary, preventive, chronic and mental healthcare to employer populations nationwide via app, web and phone. The company surpassed 1 million patient visits in early 2025 and grew members and visits by 30% in 2024, while expanding mental health into a whole-program model offering unlimited no-cost visits and next-day scheduling.
...
**Fonemed (Ventura, Calif.).** Fonemed is a population health management and telehealth solutions provider. The company offers healthcare based services and solutions like virtual nurse triage.

**Foodsmart (San Francisco).** Foodsmart is the nation’s largest foodcare provider and a telehealth nutrition platform, integrating registered dietitians, medical nutrition therapy, food access support and community engagement to address obesity, food insecurity and chronic disease. The company partners with Medicaid plans, hospital systems, and employers to serve 2.2 million members and over 1,000 employers. Outcomes include payer savings, high satisfaction scores and clinically meaningful improvements in weight loss, food security, diabetes control, and hypertension control. To improve affordability and access, Foodsmart’s “FoodsMART” marketplace partners with Walmart, Amazon and Instacart, saving members about $34 per order. The company’s policy leadership includes co-founding the Virtual Foodcare Coalition with American Telemedicine Association Action to advance reimbursement and access for virtual nutrition care.
...
**Freestate Healthcare (Wichita, Kan.).** Freestate aims to fill the gaps in healthcare for rural Americans through telemedicine applications. The company provides inpatient and outpatient telehealth services in 20 specialties to hospitals in Kansas, Nebraska, New Mexico and New York.
...
**Glooko (Palo Alto, Calif.).** Glooko transforms digital health by connecting people with diabetes and their care providers, enabling telehealth, clinical research and improved collaboration. The company empowers diabetes management by collecting and unlocking the power of data from blood glucose meters, continuous glucose monitors, insulin pumps and pens.
...
**Headspace (San Francisco).** Headspace is an online mental health resource that incorporates evidence-based meditation and mindfulness tools, mental health coaching, therapy and psychiatry. The company helps make mental health more accessible.
...
**Healthie (New York City).** Healthie is an EHR and infrastructure platform built for outpatient and value-based care. Founded in 2016, the company now serves 35,000 clinicians delivering care to 20 million patients across more than 25 medical specialties, processing 2.5 billion application programming interface calls monthly. Customers build on Healthie’s platform, which has been profitable for the majority of its history after raising $42 million to date. Healthie has been named the No. 1 “Best Place to Work” in both New York City and Los Angeles by Built In and to the “Digital Health New York 100” for four consecutive years.
...
**Infectious Disease Connect (Pittsburgh).** Infectious Disease Connect is the nation’s leading provider of telemedicine-enabled infectious diseases physician services, antimicrobial stewardship and infection prevention and control. As the only telemedicine company focused exclusively on infectious diseases and staffed by academic ID experts, the company delivers adult and pediatric inpatient consults, subspecialty care and telemedicine-enabled outpatient parenteral antibiotic therapy. At one partner hospital, ID Connect reduced average length of stay by 20%, an estimated $855,753 in annual savings, and generated an estimated $1.25 million in annual savings for a rural community health system through tele-antimicrobial stewardship. The company recently launched a graduate medical education service to help partner organizations address the nationwide shortage of infectious disease training.
...
**Innowise (Warsaw, Poland).** Innowise is a global technology partner specializing in digital transformation for the healthcare and medtech sectors, supported by more than 3,500 in-house specialists and a dedicated healthcare IT hub. The company has delivered more than 60 complex healthcare solutions for *Fortune* 500 companies and major U.S. and U.K. providers, with telehealth offerings spanning virtual hospital environments, real-time EHR synchronization and remote patient monitoring.

**InSite Health (Marlton, N.J.).** InSite Health is a vertically integrated mental-health and wellness organization serving K-12 school districts through a unified combination of clinical services, technology infrastructure and AI-enabled workflow automation. Over the past three years, the company has achieved a 296% compound annual growth rate in school partnerships, serving more than 70,000 students with more than 70% showing meaningful reductions in mental-health symptoms. Districts using InSite’s total wellness digital tools and care navigation supports have reported a 67% decrease in emergency service utilization. InSite Health also launched New Jersey’s first countywide, state-funded digital mental-health platform for K-12 systems.
...
**Iris Telehealth (Austin, Texas).** Iris Telehealth provides telepsychiatry solutions to care centers in underserved areas.
...
**Isaac Health (New York City).** Isaac Health is a scalable platform for brain health and dementia care that partners with health systems to provide virtual screening, assessment, treatment and care management for people living with dementia and their family caregivers. The company’s telehealth model has driven 73% of patients to show improved neurocognitive function over six months, with 92% improving against cognitive goals within three weeks. Isaac Health raised $10.5 million in a Series A round led by Flare Capital Partners and has expanded through partnerships with New York City-based NYU Langone Health and Eli Lilly’s LillyDirect platform. The company earned the Joint Commission’s “Gold Seal of Approval” in both 2024 and 2025 and was named to the “New York Digital Health 100.”
...
**Jedmed (St. Louis).** Jedmed develops surgical instruments for ear, nose and throat, ophthalmology and dental procedures, as well as telemedicine equipment like endoscopic video technology.
...
**Kindbridge Behavioral Health (Denver).** Kindbridge is a national telehealth program specializing in problem gambling, gaming, and co-occurring mental and behavioral health conditions. Its licensed, multi-disciplinary clinicians deliver evidence-based, outcome-driven care designed to improve recovery, engagement and quality of life. The organization operates KindCompanion, a 24/7 digital platform providing continuous access to mental health resources, self-guided tools and live clinical support. Kindbridge partners with employers, payers and community organizations to expand equitable access, enhance workforce wellbeing and reduce downstream healthcare costs. The company also provides continuing education units and professional training to grow the national clinician workforce equipped to address gambling and gaming disorders.

**KioWare (York, Pa.).** KioWare’s telehealth capabilities include self-service kiosks for billing and lockdown security for browser-based applications. The program is used in healthcare settings to power self-service telehealth and telemedicine kiosks.
...
**Lin Health (Denver).** Lin Health is a physician-led virtual care company helping health systems treat chronic pain and persistent symptom conditions through an evidence-based, multidisciplinary recovery model. Since its founding in 2021, 63% of patients have experienced clinically significant symptom reduction within their first month of care, and 81% report quality-of-life improvements by three months. Among patients using prescription pain medications at baseline, 68% reduced use and 29% discontinued entirely, while research shows a 47% reduction in primary care-related utilization among participants. Lin Health now partners with various health plans across all 50 states, expanding access to more than 114 million covered lives.

**LogicalisUS (Troy, Mich.).** Logicalis delivers digital enablement services, such as digital pillars, data center and cloud services, security and network infrastructure as well as workspace communications and collaboration. The company utilizes virtual care integration, reliable connectivity and managed services to support clinical staff while enhancing patient experience.
...
**MD Integrations (New York City).** MD Integrations is a physician-first telehealth infrastructure company that unifies clinical operations, compliance, pharmacy, diagnostics, payments and patient logistics into a single API-first platform. The company’s nationwide network of board-certified physicians has delivered more than 4 million consults across 200-plus healthcare brands, contributing to an estimated 7 million years of life added to patients treated on the platform. In 2025, MD Integrations secured a $77 million growth investment.

**MD Live by Evernorth (Miramar, Fla.).** MDLIVE provides patients and health systems access to board-certified physicians and licensed therapists through a secure online video and phone network technology platform.
...
**Medcor (McHenry, Ill.).** Medcor has simplified workplace injury care for employers since 1984, and its telehealth division is the market leader in 24/7 workplace injury triage, powered by its proprietary triage software. In 2025, the company supported 720 contracted clients across more than 501,000 locations, handling more than 417,000 calls with a speed-to-answer of just nine seconds and resolving nearly 45% of calls without offsite care. When referrals were necessary, 99% were directed in-network, and Medcor’s telehealth division achieved a 98% client renewal rate for the year.
...
**Medpod (Melville, N.Y.).** Medpod unifies telehealth software, hardware and services to aid healthcare providers in seamless care delivery. The company develops telediagnostic equipment and works with medical device manufacturers, distributors, physicians and health systems.
...
**Mend (Orlando, Fla.).** Mend is a patient engagement and telehealth solution designed for and dedicated to behavioral and mental healthcare organizations. The company has surpassed 15 million patient appointments and serves as the patient engagement partner of the National Council for Mental Wellbeing. The company’s customers are now averaging single-digit no-show rates.
...
**Mindful Therapy Group (Mountlake Terrace, Wash.).** Mindful Therapy Group is a clinician-led, multi-state behavioral health practice founded in 2011, now counting more than 2,500 independent providers across six states. The company serves more than 100,000 patients annually through more than 1 million sessions delivered via a hybrid model combining telehealth with more than 20 brick-and-mortar locations, connecting patients to care within 48 hours compared with an industry average of 30 to 40 days. The company reports a 10% clinician turnover rate, well below the 30% to 60% industry norm, alongside 40% of patients recovering from depression and 57% from anxiety, both above national averages. The company was named to the 2025 “Inc. 5000” list of America’s fastest-growing private companies.
...
**MobilityZ Health (Houston).** MobilityZ Health is a telehealth-based orthopedic injury analysis technology company serving orthopedic practices, offering access to care in rural areas. It enables providers to conduct remote monitoring and range-of-motion assessments for post-surgical, rehab and clinical visits through telehealth. This innovation saves time for orthopedic surgeons, reduces appointment cancellations, improves patient adherence and minimizes travel time for patients while expanding access to quality care.

**ModMed (Boca Raton, Fla.).** ModMed and its affiliated companies provide a telemedicine app for various specialties including: dermatology, ophthalmology, orthopedics, plastic surgery/cosmetics, otolaryngology and gastroenterology. It directly integrates with the company’s EHR system.
...
**My Mountain Mover (Orange, Calif.).** My Mountain Mover provides highly trained medical virtual assistants to telehealth providers and practices nationwide, founded in 2020. The company has supported more than 1,000 healthcare practices with more than 1,600 virtual assistants, helping clients reduce employment costs by up to 70% while maintaining an 89% client retention rate and 81% virtual assistant retention rate. In 2025, My Mountain Mover launched “Mover Match,” an AI-powered tool that shortened hiring timelines from months to days. The company earned two “Gold Stevie Awards” in 2025.
...
**Nextech Systems (Tampa, Fla.).** Nextech provides options for patients to meet their needs virtually and offers a fully integrated telehealth solution that seamlessly integrates within existing EHR workflows.

**NextGen Healthcare (Fredericksburg, Va.).** NextGen Healthcare, a fully remote company, is a technology partner for ambulatory practices whose NextGen Virtual Visits solution is embedded directly within its EHR and practice management systems. More than 31,000 providers across 450 client organizations use the platform to conduct real-time video visits, schedule follow-ups, send referrals and support group visits for diabetes education, chronic care management and behavioral health. The company has been named the No. 1 practice management solution by Black Book Research for nine consecutive years and to *Newsweek* ‘s “Most Trustworthy Companies in America” list in 2025. NextGen also earned 2025 Best in KLAS recognition for behavioral health and was named a *Forbes* “Best Midsize Employer.”
...
**Nsight Health (Miami).** Nsight Health is a self-funded, founder-led remote care company delivering fully managed telehealth and remote care programs to more than 110,000 patients through 1,600-plus provider teams nationwide. Founded in 2018, the company has grown cumulative revenue by more than 23,000% since 2021, including 140% year-over-year growth in 2025, across six clinically managed programs spanning remote patient monitoring, chronic care management and behavioral health integration. Its platform integrates with more than 500 EHR systems and has driven validated clinical outcomes, including a 49% reduction in critical hypertensive alerts and a 72% reduction in critical heart failure indicators within two months. Nsight, which employs 437 people including nearly 200 clinical professionals, was named a 2026 “South Florida Top Workplace” by the *Sun Sentinel.*

**Nudj Health (Austin, Texas).** Nudj Health is a technology-enabled healthcare company delivering whole-person virtual care for chronic disease prevention and reversal, partnering with health systems, employers and payers through interdisciplinary teams of physicians, behavioral health clinicians, dietitians and health coaches. The company’s measurement-based programs have reported a 44% reduction in depression, a 39% reduction in anxiety and roughly 6% average weight loss among patients, alongside approximately $3,000 in annualized direct cost savings per patient. Nudj Health was selected for CMS’ “ACCESS Model” cohort launching in 2026, reflecting the shift toward accountable, outcomes-driven chronic disease care. Its program is also certified through the American College of Lifestyle Medicine.
...
**PatientClick (San Diego).** PatientClick provides an integrated video-based telemedicine platform as a software-as-a-service with EHR and practice management solutions. The company also provides an on-demand telemedicine platform.
...
**Phamily (Cincinnati).** Phamily enables health systems and medical groups to launch and scale chronic and preventive care programs with its purpose-built AI-powered platform, turnkey clinical staffing and expert program management. Phamily’s continuous care model drives high patient engagement and sustainable revenue from chronic care management, advanced primary care management and other programs, helping organizations deliver proactive care at population scale.
...
**RedBox Rx (West Des Moines, Iowa).** RedBox Rx, a subsidiary of Hy-Vee, provides low-cost national telehealth and online pharmacy services with specialties in mental health, men’s and women’s health, and nearly 30 additional conditions. Patients ages 18 and older can access live video or chat visits with licensed providers, with mental health visits starting at $25 and other consults ranging from free to $39, with no insurance required. RedBox Rx offers a mobile app for scheduling and care management, and has expanded into weight management with medications and virtual dietitian consultations. The company has also introduced affordable, pay-as-you-go online therapy sessions to remove cost barriers to mental health care. Backed by Hy-Vee’s 55 years of pharmacy expertise, RedBox Rx is experiencing rapid nationwide growth while prioritizing affordability and access.
...
**Rula Health (Santa Clara, Calif.).** Rula Health provides affordable, high-quality mental and behavioral healthcare through a network of over 9,000 licensed providers. They offer therapy and psychiatric services to individuals, couples and families, partnering with major insurance networks to cover over 100 million individuals. Founded in 2019, Rula focuses on evidence-based, outcome-driven care and supports providers by handling administrative tasks. Their mission is to make mental healthcare accessible and effective for everyone.

**ScienceSoft USA (McKinney, Texas).** ScienceSoft USA provides IT consulting and custom software development for the healthcare industry, having delivered more than 150 healthcare projects since entering the medical IT market in 2005. The company’s team of more than 750 IT experts builds patient-centered telemedicine, remote patient monitoring and wellness apps that reach 95%-plus user satisfaction scores, alongside AI-powered diagnostic software achieving 90% to 95% output accuracy. For bioAffinity Technologies, ScienceSoft built a lung cancer detection app showing 92% sensitivity and 87% specificity, while a wearable physiotherapy platform built for AKLOS Health reported a 70% reduction in pain and unnecessary surgeries among users. ScienceSoft was named to the *Financial Times* ‘ “Americas’ Fastest Growing Companies,” ranking in 2026 for a fifth consecutive year.
...
**Senscio Systems (Harvard, Mass.).** Senscio Systems’ Ibis solution provides an AI-based comprehensive health management program for individuals with complex chronic conditions. The technology realizes the earliest signs of health issues and engages members to take self-rescue actions.
...
**SimplePractice (Santa Monica, Calif.).** SimplePractice is a practice management and EHR platform trusted by more than 250,000 solo and group mental health practitioners, delivering more than 125 million sessions of care to more than 10 million individuals annually. Its AI-powered “Note Taker” tool is the No. 1 market leader among AI note-taking software for mental health clinicians, saving clinicians up to five hours per week and enabling up to $950 in additional monthly earnings. The company’s inaugural annual report, analyzing data from more than 245,000 practitioners, found that 47.5% of the more than 113 million sessions studied were conducted via telehealth. SimplePractice was named the winner of the “Best Practice Management Solution Provider” category at the 2026 “MedTech Breakthrough Awards.”
...
**Solace Health (Redwood City, Calif.).** Solace Health is the nation’s leading healthcare advocacy platform, connecting patients with dedicated advocates who handle scheduling, insurance battles and care coordination. Solace is covered by insurance nationwide, including Medicare and most major commercial health plans, and expanded coverage in April 2026. In February 2026, the company closed a $130 million Series C round, pushing its valuation above $1 billion, and announced partnerships with Disabled American Veterans and the American Legion to connect veterans with dedicated advocates. Solace also partners with the American Diabetes Association and is a member of the National Health Council.
...
**StationMD (Maplewood, N.J.).** StationMD is a telemedicine service dedicated to individuals with intellectual and/or developmental disabilities, along with other vulnerable populations.
...
**Talkiatry (New York City).** Talkiatry is a physician-led, fully virtual psychiatry practice, offering in-network care with eligible clinicians averaging over 10 years of experience. Patients match with a psychiatrist in minutes and book within days for 60-minute evaluations and 30-minute follow-ups, covering a broad spectrum of conditions. Clinical quality is reinforced by rigorous diagnostics, medication-safety protocols, emergency escalation pathways and outcomes monitoring. Partnerships with health systems and national payers support integrated, value-based care, resulting in fewer hospitalizations and fewer emergency department visits.

**Talkspace (New York City).** Founded in 2012 as the first platform to text a licensed therapist from anywhere, Talkspace now delivers comprehensive digital behavioral health with more than 6,000 therapists and prescribers, plus self-guided tools and live streaming content. An NYU-developed algorithm for detecting suicidal ideation and self-harm has flagged risk cases at with high accuracy since its 2019 integration, strengthening platform safety. Partnerships with Cigna, Aetna, TRICARE contractors and Medicare provide in-network access, typically matching members to a provider within 1–2 days. Public-health collaborations have also expanded free therapy for youth, with engagement concentrated in equity-priority communities.

**TandemStride (Cleveland).** TandemStride is a digital recovery platform supporting trauma and injury survivors after hospital discharge, partnering with trauma centers, health systems and Medicaid managed care organizations to provide recovery navigation, peer support and AI-powered resource coordination. The company has supported thousands of injury survivors across Ohio and won the Ohio Association of Health Plans’ 2025 “Pinnacle Award” for innovative approaches to member engagement. In 2026, TandemStride was selected as the platform of delivery for the “HEART Trial,” a $16.6 million, Patient-Centered Outcomes Research Institute-funded multicenter study on comprehensive care models for orthopedic trauma recovery. The company also serves as the virtual support infrastructure for the American Trauma Society’s trauma survivors network and recently launched “Communities,” a peer-connection feature within its platform.
...
**Teladoc Health (New York City).** Teladoc Health is the global leader in virtual care, operating for more than 20 years and giving more than 100 million Americans access to its services through the largest nationwide network of virtual care providers. In 2026, the company announced partnerships with Instacart to link its cardiometabolic programs to grocery access and with Walmart to offer virtual urgent care, dermatology and nutrition support through the retailer’s “Better Care Services” platform. Teladoc also expanded its employer benefits reach through the LillyDirect Employer Connect partnership. The company has been named to *USA Today* ‘s “Most Trusted Brands in America” list and *Newsweek* ‘s “Most Trustworthy Companies” list in both 2025 and 2026.

**Teledentistry.com (Las Vegas).** Teledentistry.com provides 24/7 virtual dental consultations for urgent oral health needs, connecting patients to licensed clinicians in real time. The platform’s mission is to improve oral health through digital access to care and clinician guidance. Recent technology upgrades added integrated photo assessments and enhanced access features that streamline triage and treatment recommendations. A partnership with Delta Dental extends virtual access to care to more than 37 million members, accelerating timely interventions and reducing unnecessary emergency room visits. By bringing emergency dental expertise to patients wherever they are, Teledentistry.com closes critical care gaps and supports payer and provider networks with scalable, always-on access.

**Telehealth.org (Charleston, S.C.).** Telehealth.org offers telemental and telebehavioral health training, consulting and staffing assistance with personal training delivered to over 56,000 medical and behavioral health specialists across 109 countries.
...
**Tellihealth (Houston).** Tellihealth is one of the largest providers of remote intelligent care services in the U.S. The company offers a fully integrated solution for both remote patient monitoring and chronic care management. Through seamless integrations with leading EHR platforms, FDA-approved 4G-enabled devices, and a proprietary AI engine, Tellihealth enables clinics to scale connected care effortlessly. Supported by a 24/7 bilingual clinical team, the platform delivers a turnkey experience that improves patient outcomes, engagement and efficiency without adding administrative burden or upfront costs.
...
**TigerConnect (El Segundo, Calif.).** TigerConnect is a cloud-native platform trusted by healthcare organizations. The patient communication solution, Patient Engagement, allows healthcare professionals to communicate with patients, families and specialists through voice, video or text.
...
**UTM Healthcare (Hudson, N.Y.).** UTM Healthcare, or “YouThisMe,” offers a seamless, secure, HIPAA-compliant and simple-to-use remote patient monitoring system that allows patients to remain in their homes while giving providers essential information for managing chronic conditions and avoiding hospital readmissions.
...
**VideoConnex (Sanford, Fla.).** VideoConnex is a consulting firm that provides a network collaboration infrastructure for multisite interactive collaboration at world sporting events, among other occasions. Their services have been used for telemedicine projects.
